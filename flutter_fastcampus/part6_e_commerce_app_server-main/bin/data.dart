...
List<ViewModuleDto> viewModules(String mallType) {
  return [
    ViewModuleDto(type: 'carousel_view_module', products: [
      ProductInfoDto(
        imageUrl: bannerImageList[0],
      ),
      ProductInfoDto(
        imageUrl: bannerImageList[1],
      ),
      ProductInfoDto(
        imageUrl: bannerImageList[2],
      ),
      ProductInfoDto(
        imageUrl: bannerImageList[3],
      ),
      ProductInfoDto(
        imageUrl: bannerImageList[4],
      ),
    ]),
    ViewModuleDto(
...
List<ProductInfoDto> productGenerator(int length, String storeType) {
  ...
  var productList =
      storeType == 'market' ? marketProductList : beautyProductList;

  List<ProductInfoDto> list = List.generate(
    length,
    (index) {
