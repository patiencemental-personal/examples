...
import type { LoadComponentsReturnType } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/server/load-components';
import type { ServerRuntime } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/types';
import type { FontLoaderManifest } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/build/webpack/plugins/font-loader-manifest-plugin';
import React from 'next/dist/compiled/react';
import { NextParsedUrlQuery } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/server/request-meta';
import RenderResult from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/server/render-result';
import { FlightCSSManifest, FlightManifest } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/build/webpack/plugins/flight-manifest-plugin';
import { RequestCookies } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/server/web/spec-extension/cookies';
...
export declare type RenderOptsPartial = {
    ...
    isBot?: boolean;
    incrementalCache?: import('.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/server/lib/incremental-cache').IncrementalCache;
