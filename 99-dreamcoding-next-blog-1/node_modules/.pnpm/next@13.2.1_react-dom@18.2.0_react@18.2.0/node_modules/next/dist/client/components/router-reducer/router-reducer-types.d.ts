import { CacheNode } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/shared/lib/app-router-context';
import { FlightRouterState, FlightData } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/server/app-render';
import { fetchServerResponse } from '.pnpm/next@13.2.1_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/client/components/router-reducer/fetch-server-response';
...
export declare type ReducerActions = Readonly<RefreshAction | NavigateAction | RestoreAction | ServerPatchAction | PrefetchAction>;
export { };
